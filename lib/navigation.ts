...
{label:'Deliverable review',href:'/deliverables',icon:'ClipboardList',section:'Creator operations'},
{label:'Projects',href:'/projects',icon:'FolderKanban',section:'Project operations'},
{label:'External commission',href:'/external-commissions',icon:'BriefcaseBusiness',section:'Project operations'},
{label:'Commissions',href:'/commissions',icon:'Handshake',section:'Project operations'},
...
{label:'Indexes',href:'/indexes',icon:'ChartNoAxesCombined',section:'Rights & registry'},
{label:'Certificates',href:'/certificates',icon:'FileSignature',section:'Rights & registry'},
{label:'Profiles',href:'/profiles',icon:'Users',section:'Distribution'},
{label:'Releases',href:'/releases',icon:'PlaySquare',section:'Distribution'},
{label:'Collections',href:'/collections',icon:'LibraryBig',section:'Entertainment'},
...
{label:'Team files',href:'/internal-files',icon:'FolderKanban',section:'Growth & corporate'},
